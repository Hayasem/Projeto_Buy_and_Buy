                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        if (user != null) {
                            user.sendEmailVerification().addOnCompleteListener(emailTask -> {
                                if (emailTask.isSuccessful()) {
                                    Toast.makeText(FormCadastro.this, "Verifique seu e-mail para validar a conta.", Toast.LENGTH_SHORT).show();
                                    ...
                                    Toast.makeText(FormCadastro.this, "Erro ao enviar email de verificação.", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                        ...
                        if (exception instanceof FirebaseAuthUserCollisionException) {
                            ...
                            Toast.makeText(FormCadastro.this, "Este e-mail já está sendo utilizado.", Toast.LENGTH_SHORT).show();
                        } else {
                            Log.e("AuthError", "Erro ao criar usuário", exception);
                            Toast.makeText(FormCadastro.this, "Erro ao criar conta. Tente novamente.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
